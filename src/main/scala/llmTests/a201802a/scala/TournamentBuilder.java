package llmTests.a201802a.scala;
...
public interface TournamentBuilder {
	 ...
	 */
	TournamentBuilder setType(llmTests.a201802a.java.Tournament.Type type);
	 ...
	 */
	TournamentBuilder addResult(String player, llmTests.a201802a.java.Tournament.Result result);
